...
Partial Class admin_Efile
    ...
    Private Sub BindData()
        ...
        tmp = Me.DropDownListEFileStatus.SelectedValue
        Me.DropDownListEFileStatus.DataSource = TimssBll.GetDistinctEfileStatusNameValuePairList()
        Me.DropDownListEFileStatus.DataBind()
        TimssBll.SetDropDownListSelectedValue(Me.DropDownListEFileStatus, tmp)

        If Not IsPostBack Then
            If Not String.IsNullOrEmpty(Request.QueryString("es")) Then
                TimssBll.SetDropDownListSelectedValue(Me.DropDownListEFileStatus, Server.HtmlEncode(Request.QueryString("es")))
            End If
        End If
        ...
        If Not String.IsNullOrEmpty(Me.DropDownListEFileStatus.SelectedValue) Then
            args.FilterParameters.Add(New FilterParameter("EfileStatusCode", Server.HtmlDecode(Me.DropDownListEFileStatus.SelectedValue), "equals"))
        End If
        ...
        Dim dt As DataTable = TimssBll.GetEfileDetailsDataTable(args)
    ...
    Sub ContactsGridView_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles GridViewList.RowCommand
        If e.CommandName = "unlockclasslistedit" Then
            Dim id As String = e.CommandArgument
            TimssBll.UnlockClassListEditting(id)
            BindData()
        ElseIf e.CommandName.Equals("DownloadEfile") Then
    ...
    Sub CurrentPage_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListGrade.SelectedIndexChanged, DropDownListEFileStatus.SelectedIndexChanged, DropDownListDPStatus.SelectedIndexChanged
        BindData()
    End Sub
