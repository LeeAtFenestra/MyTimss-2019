...
Partial Class admin_efilecleanstudentdata
    ...
    Public Property GridViewSortColumn() As String
        Get
            If ViewState("GridViewSortColumn") = Nothing Then
                ViewState("GridViewSortColumn") = "Row"
            End If
    ...
    Private Sub BindData()
        ...
        Dim dt As DataTable = TimssBll.GetEfileCleanedStudetDataTable(Request.QueryString("fileid"), args)
