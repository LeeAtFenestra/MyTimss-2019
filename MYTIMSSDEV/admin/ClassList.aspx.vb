...
Partial Class admin_ClassList
    ...
    Private Sub BindData()
        ...
        Dim dt As DataTable = TimssBll.GetClassListSubmittedDataTable(args)
    ...
    Sub CurrentPage_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListGrade.SelectedIndexChanged
        BindData()
    End Sub
End Class
