<%@ Page Title="Submit Teacher List" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="SubmitTeacherList.aspx.vb" Inherits="SubmitTeacherList" %>
...
<input type="hidden"  name="reader" value = 'False' size="8">
                ...
                <h3>Submit Teacher List</h3>
       <asp:Label ID="lblNotAvailable"  Visible="false"  runat="server" Text="The page will go live in January, 2018, after we have emailed you instructions for submitting lists."></asp:Label>                   
    <asp:Panel ID="PanelGrade4ClassListNeeded" runat="server" Visible="false">
    
    <b>&nbsp;Grade 4</b>
    <br />
    <br />
    You need to submit your class list before you can submit your teacher list.
    </asp:Panel>
    ...
    <b>&nbsp;Grade 4 File</b>
        <br />
    <br />
    <p>Along with the list of classes, TIMSS needs a complete and current list of <b>all teachers</b> in grade 4 in order to draw a random sample of classes (and therefore teachers) to participate in the assessment. Your teacher data electronic file (E-File) must be submitted as a Microsoft Excel file.</p>
    <p>You may use the TIMSS E-File Excel Template or you may provide an Excel file with the same information. Include the following information for each teacher:</p>
    <ul>
        <li>Class: The fourth-grade class the teacher is enrolled in. Please use the same unique class names you used in the Submit Class List screen.</li>
        <li>Teacher Name: Teacher of the above named class.</li>
        <li>Teacher Name: The preferred format is First Name, Middle Name (or Initial), and Last Name in separate columns. However, TIMSS will accept teacher names in one column.</li>
    ...
    It is preferred that you include column headers as the first row in your E-File (see templates for examples in <a href="documents.aspx">Documents</a>).  However, E-Files without column headers will be accepted. If you cannot submit your teacher data with this information in an Excel file, please call or email the TIMSS E-File Help Desk at <a href="mailto:TIMSSefile@westat.com">TIMSSefile@westat.com</a> or 1-855-457-1577. 
<br />
<br />
        ...
        Does your teacher data file contain <a class="links" href="Javascript:alert('A column header identifies the type of teacher data in a column (ie. Teacher Name, Sex, Race, etc...).');">column headers</a>:
...
<asp:Panel ID="PanelICILSUploadInstructions" runat="server" Visible="false">
    <p>ICILS needs a complete and current list of <b>all teachers who teach at least one grade 8 class</b> or 8<sup>th</sup> grade student in order to draw a random sample of teacher to participate in the teacher online questionnaire. Your teacher data electronic file (Teacher E-File) must be submitted as a Microsoft Excel file.</p>
    <p>You may use the ICILS Teacher E-File Excel Template or you may provide an Excel file with the same information. Include the following information for each student:</p>
    <ul>
        <li>Teacher Name: The preferred format is First Name, Middle Name (or Initial), and Last Name in separate columns. However, ICILS will accept teacher names in one column.</li>
        <li>Sex:  Codes for Male/Female. </li>
        <%--<li>Year of Birth: YYYY</li>--%>
        <li>Main Subject the Teacher Teaches:  1=Language Arts; 2=Social Studies; 3=Mathematics & Sciences; 4=Other; 9=Missing.</li>
        <li>Teacher Email (work email)</li>
    </ul>
    It is preferred that you include column headers as the first row in your Teacher E-File (see templates for examples in <a href="documents.aspx">Documents</a>). 
    However, E-Files without column headers will be accepted. If you cannot submit your teacher data with this information in an Excel file, please call or email the ICILS Help Desk at <a href="mailto:ICILS@westat.com">ICILS@westat.com</a> or 1-855-445-5604. 
...
<br />
    ...
    <br />
    <br />
    <p>TIMSS needs a complete and current list of <b>all 12th-grade teachers who have taken or are currently taking eligible advanced mathematics and physics courses</b> in order to draw a random sample of teachers to participate in the TIMSS Advanced assessment.  Eligible courses for your school were sent to you via email.  Your teacher data electronic file (E-File) must be submitted as a Microsoft Excel file.</p>
    <p>Include the following information for each teacher:</p>
    <ul>
        <li>Teacher Name:  The preferred format is First Name, Middle Name (or Initial), and Last Name in separate columns.  However, TIMSS Advanced will accept teacher names in one column.</li>
        <li>Teacher ID:  school or state ID.  Please do not use social security numbers.</li>
    ...
    <p>If you cannot submit your teacher data with this information in an Excel file, please email or call the TIMSS E-File Help Desk at <a href="mailto:TIMSSefile@westat.com">TIMSSefile@westat.com</a> or 1-855-457-1577.</p>
                        		        <table border="1" cellpadding="4" cellspacing="0">
    ...
    <asp:Repeater ID="RepeaterGrade12Uploads" runat="server">
        ...
        <p>Thank you for submitting your teacher list!  The TIMSS Advanced Team will contact you in a few weeks with information about the teachers selected for the assessment.</p>
    </asp:Panel>
...
<br />
        ...
        <ul>
            ...
            <li>Number: The number of teachers in your E-File with that value</li>
        ...
        <ul>
            <li>Your Values: The values in your Teacher E-File</li>
            <li>ICILS Codes: Click on the down arrow and select the ICILS Code that best matches Your Values</li>
            <li>Number: The number of teachers in your E-File with that value</li>
            <li>Percentage: The percentage in your Teacher E-File with that value </li>
        </ul>
        <p>Use the Previous and Next buttons to navigate from column header to column header.</p>
        </asp:Panel>
        ...
        Update All Codes: <asp:DropDownList ID="DropDownListDateFormat" runat="server" DataTextField="name" DataValueField="value"  onchange = "BatchDateFormatUpdate();"></asp:DropDownList>
            ...
            <asp:Repeater ID="RepeaterMapValues" runat="server">
                <HeaderTemplate>
				        ...
				        <td id="Td1" align="center" runat="server" visible='<%#IsClassColumn() %>'><Font size=2><B>Class List</B></Font></td>
				        <td id="Td2" align="center" runat="server" visible='<%#Not IsClassColumn() %>'><Font size=2><B>Codes</B></Font></td>
                ...
                <ItemTemplate>                    
				      ...
				      <td id="Td3" runat="server" visible='<%#IsClassColumn() %>'>
				      ...
				      <td id="Td4" runat="server" visible='<%#Not IsClassColumn() %>'>
        ...
        <asp:Panel ID="PanelVerifyInstructionseTIMSS" runat="server">
            <b>Verify Your E-File</b>
                <br />
                <p>The table below summarizes the information you have provided on your teacher list (E-File). Please review this summary and verify that the information is correct. Total Enrollment at the bottom of the table should match the number of teachers in your E-File, and the total number of teachers currently enrolled in grade <%=Me.theFile.SmpGrd()%>.<p/>
        ...
        <asp:Panel ID="PanelVerifyInstructionsICILS" runat="server">
            <b>Verify Your Teacher E-File</b>
                <br />
                <p>The table below summarizes the information you have provided on your teacher list (Teacher E-File). Please review this summary and verify that the information is correct. Total Enrollment at the bottom of the table should match the number of teachers in your E-File, and the total number of teachers currently enrolled in grade <%=Me.theFile.SmpGrd()%>.<p/>
                <p>Record whether the information is correct or incorrect by selecting the appropriate button at the bottom of the page. Then click the Submit button. If you select incorrect, you will need to correct your E-File and resubmit it.</p>
            ...
            <asp:Repeater ID="RepeaterVerify" runat="server">
                <HeaderTemplate>
				        ...
				        <td id="Td5" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade4() %>'><Font size=2><B>Number</B></Font></td>
				        <td id="Td6" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade4() %>'><Font size=2><B>Percentage</B></Font></td>
				        <td id="Td7" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade8() %>'><Font size=2><B>Number</B></Font></td>
				        <td id="Td8" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade8() %>'><Font size=2><B>Percentage</B></Font></td>
				        <td id="Td9" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade12() %>'><Font size=2><B>Number</B></Font></td>
				        <td id="Td10" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade12() %>'><Font size=2><B>Percentage</B></Font></td>
                        

				        </tr>
                </HeaderTemplate>
                <ItemTemplate>                      
				      <tr id="Tr1" runat="server" visible='<%# HandleVerifyColumnHeaderVisibility(Container.DataItem("NaepLabel")) %>'>
				      <td colspan="7" bgcolor="#cccccc"><%#Container.DataItem("NaepLabel")%></td>
					  </tr>             
				      <tr>
				      <td>&nbsp;&nbsp;&nbsp;<%#Container.DataItem("CodeLabel")%></td>
				      <td id="Td11" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade4() %>'><%#Container.DataItem("TotalResponsesGrade4")%></td>
				      <td id="Td12" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade4() %>'><%#TimssBll.CalcPercentage(Container.DataItem("TotalResponsesGrade4"), Me.theFile.TotalRows, 2)%>%</td>
				      <td id="Td13" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade8() %>'><%#Container.DataItem("TotalResponsesGrade8")%></td>
				      <td id="Td14" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade8() %>'><%#TimssBll.CalcPercentage(Container.DataItem("TotalResponsesGrade8"), Me.theFile.TotalRows, 2)%>%</td>
				      <td id="Td15" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade12() %>'><%#Container.DataItem("TotalResponsesGrade12")%></td>
				      <td id="Td16" align="center" runat="server" visible='<%#Me.theFile.FileHasGrade12() %>'><%#TimssBll.CalcPercentage(Container.DataItem("TotalResponsesGrade12"), Me.theFile.TotalRows, 2)%>%</td>
					  </tr>
                </ItemTemplate>
        ...
        <asp:Panel ID="PanelThanks" runat="server" Visible="false">
                ...
                <p>TIMSS will process your submission and select the sample of <%=Me.theFile.SmpGrdString()%>-grade classes to be assessed. In a few days you will receive an email explaining which classes were selected.</p>
                <p>A TIMSS representative will contact you after March 23 to make arrangements for the assessment.</p>
                </asp:Panel>

                <asp:Panel ID="PanelIncorrect" runat="server" Visible="false">
                <p>You have indicated that your teacher information is incorrect.   Please correct your E-File and resubmit.  If you need assistance, please contact the TIMSS Help Desk at <a href="mailto:TIMSS@westat.com">TIMSS@westat.com</a> or 855-445-5604.</p>
                </asp:Panel>

                 <asp:Panel ID="PanelCorrectICILS" runat="server" Visible="false">
                <p>Thank you for submitting your E-File!</p>
                <p>ICILS will process your submission and select the sample of <%=Me.theFile.SmpGrdString()%>-grade teachers to take the questionnaire. Soon you will receive an email explaining which teachers were selected.</p>
                <p>A Westat ICILS staff representative will contact you soon to make arrangements for the assessment. Please make sure to complete the Submit Student List page if you haven't already.</p>
                </asp:Panel>

                <asp:Panel ID="PanelIncorrectICILS" runat="server" Visible="false">
                <p>You have indicated that your teacher information is incorrect.   Please correct your E-File and resubmit.  If you need assistance, please contact the ICILS Help Desk at <a href="mailto:ICILS@westat.com">ICILS@westat.com</a> or 855-445-5604.</p>
                </asp:Panel>
