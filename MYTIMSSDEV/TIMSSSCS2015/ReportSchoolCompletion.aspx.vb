...
Partial Class TIMSSSCS2015_ReportSchoolCompletion
    ...
    Public Property GridViewSortColumn() As String
        Get
            If ViewState("GridViewSortColumn") = Nothing Then
                ViewState("GridViewSortColumn") = "DISP"
            End If
    ...
    Private Sub BindData()
        ...
        Me.DropDownListState.DataSource = TimssBll.GetStateNameValuePairListForTerritory(Me.DropDownListTerritory.SelectedValue, True)
        ...
        Dim dt As DataTable = TimssBll.GetSchoolCompletionReportDateTable(args)
    ...
    Sub DropDownList_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListSchoolType.SelectedIndexChanged, DropDownListTerritory.SelectedIndexChanged, DropDownListState.SelectedIndexChanged, DropDownListRegion.SelectedIndexChanged, DropDownListExport.SelectedIndexChanged
        Me.BindData()
    End Sub
    ...
    Private Sub ExportGridviewToExcel()
        ...
        End If
        Me.BindData()
        GridViewExportUtil.Export2("ReportSchoolCompletion.xlsx", GridViewSchoolList, True)
    End Sub
