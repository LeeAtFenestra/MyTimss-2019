<%@ Page Title="School Detail Report" Language="VB" MasterPageFile="~/TIMSSSCS2015/TIMSSSCS2015.master" AutoEventWireup="false" CodeFile="ReportSchoolDetail.aspx.vb" Inherits="TIMSSSCS2015_ReportSchoolDetail" %>
        ...
        <TR>
          <TD colSpan=2>
            ...
            <a href="ReportQuestionnaireStatus.aspx" class="menu" title="Questionnaire Status Report">Questionnaire Status Report</a>                  
                  |
            <a href="ReportSchoolDetail.aspx" class="menuOn" title="School Detail">School Detail</a>
...
<asp:ImageButton ID="ImageButtonXportToExcel" runat="server" ImageUrl="~/common/images/Excel.jpg" Width="20" Height="20" ToolTip="Excel Export" />
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="School Name" 
              ...
              <asp:BoundField HeaderText="Study Name" 
                  DataField="Study_Name" SortExpression="Study_Name">
                  </asp:BoundField>
          ...
          <%--  <asp:TemplateField HeaderText="Assessment date 2" SortExpression="ScheDate2">
            ...
            <asp:BoundField HeaderText="Assessment Completed?" 
                  DataField="AssessmentCompleted" SortExpression="AssessmentCompleted">
                  </asp:BoundField>       
