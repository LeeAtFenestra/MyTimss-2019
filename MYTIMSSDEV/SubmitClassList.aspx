...
<asp:Content ID="Content5" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <input type="hidden"  name="reader" value = "False" />
                ...
                <p>TIMSS needs a complete and current list of all of your school’s fourth-grade classes in order to randomly select classes to be assessed. Typically, two classes are sampled in each school, and all fourth-grade students in the selected classes will be assessed.</p><p>Enter the data for each class in the form below. After you have entered information for a class, click on save, and another row will appear for you to enter information about another class. Continue until you have entered information for all classes that contain fourth-grade students.</p><p>
                    Include the following information for each class (<b><font color="red">&#10038;</font></b> indicates a required field): <table border="1" cellpadding="15" cellspacing="0">
                        <tr valign="top">
                            ...
                            <td><b><font color="red">&#10038;</font></b>Class Group or Track (use Average if none)</td><td>If your school assigns students to specific classes based on their ability, please indicate the relevant level: Low ability, Average ability, or High ability.</td></tr><tr valign="top">
                            <td><b><font color="red">&#10038;</font></b>Number of 4<sup>th</sup>-grade students in each class</td><td>Enter the number of fourth-grade students in each class. In the case of <i>multi-grade classes</i> (e.g., students from more than one grade level in the same class), only the fourth-grade students should be counted as a class in the list. For example, if three Grade 3 students, five Grade 4 students, and ten Grade 5 students form a multi-grade class, then you should record five students for the number of students in this multi-grade class.</td></tr><tr valign="top">
                    ...
                    Tips: <p>
                        ...
                        reference.</li><li>Each class name must be unique. Do not just type in “Grade 4 class” several times. We must be able to differentiate between classes, so please use different class names for each class with at least one 4th-grade student.</li><li>Click on the <i>Finished</i> button when you have entered all fourth-grade 
                        classes in the form. Then go to the Submit Student List page.</li></ul><p>
                        </p>
                        <div ID="popG4ClassName" class="popbox">
                            ...
                            <b><i>Class Group or Track</i></b> (use Average if none): If your school assigns 
                            ...
                            Please contact <a href="mailto:TIMSS@westat.com">TIMSS@westat.com</a> if you have questions. <br /><br /><ol>
                            ...
                            <b><i>Name of Teacher:</i></b> Name of Teacher <br /></div><div ID="popG4ScienceofMath" class="popbox">
                            <b><i>Name of Science Teacher:</i></b> Name of Science Teacher of class<br /></div><div ID="popG4NameofScienceTeacher" class="popbox">
                            <b><i>Name of Science Teacher:</i></b>&nbsp;Name of Science Teacher of class (only if different from Mathematics Teacher).<br /></div><div ID="popG4ScienceTeacherEmail" class="popbox">
                            <b><i>Email address of Science Teacher:</i></b> Email address of Science Teacher of class (only if different from Mathematics Teacher).<br /></div><div ID="popG4NameofMath" class="popbox">
                            <b><i>Name of Mathematics Teacher:</i></b> Name of Mathematics Teacher of class<br /></div><div ID="popG4MathTeacherEmail" class="popbox">
                            ...
                            <tr ID="trG4Header" runat="server" 
                                ...
                                <td align="center">
                                    ...
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a></Font>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Class Group (use Average if none)</b></font> </td><td align="center" style="width:15%">
                                    <a class="popper" data-popbox="popG4NumStu" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Number of 4th-grade students in class<br />(most classes have less than 30 students)</b> </font></td><td align="center">
                                    ...
                                    <img border="0" 
                                        ...
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Name of Mathematics Teacher</b></font> </td><td align="center">
                                             <a class="popper" data-popbox="popG4MathTeacherEmail" href="#">
                                                 <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Email address of Mathematics Teacher</b></font></td><td align="center">
                                    <a class="popper" data-popbox="popG4NameofScienceTeacher" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<font size="2"><b>Name of Science Teacher (only if different from Mathematics Teacher)</b></font> </td><td align="center">
                                             <a class="popper" data-popbox="popG4ScienceTeacherEmail" href="#">
                                                 <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<font size="2"><b>Email address of Science Teacher (only if different from Mathematics Teacher)</b></font></td></tr><asp:Repeater ID="RepeaterClassList4ReadOnly" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td align="center">
                                            &nbsp;</td><td>
                            ...
                            <asp:Repeater ID="RepeaterClassList4" runat="server">
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="dbG4_NameOfMathematicsTeacherEmailG4" runat="server" MaxLength="60" 
                                        onchange="Edited();" size="35"></asp:TextBox><asp:RegularExpressionValidator ID="regexEmailValiddb_NameOfMathematicsTeacherEmailG4" runat="server" 
                                                         ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                                    ...
                                    <asp:TextBox ID="dbG4_NameOfScienceTeacherG4" runat="server" MaxLength="60" 
                                        onchange="Edited();" size="35"></asp:TextBox></td><td>
                                    <asp:TextBox ID="dbG4_NameOfScienceTeacherEmailG4" runat="server" MaxLength="60" 
                                        onchange="Edited();" size="35"></asp:TextBox><asp:RegularExpressionValidator ID="regexEmailValiddb_NameOfScienceTeacherEmailG4" runat="server" 
                                                         ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                                                         ControlToValidate="dbG4_NameOfScienceTeacherEmailG4" Display="Dynamic" 
                ...
                <p>TIMSS needs a complete and current list of all of your school’s eighth-grade Mathematics classes in order to randomly select classes to be assessed. Typically, two mathematics classes are sampled in each school, and all eighth-grade students in the selected classes will be assessed.</p><p>Enter the data for each class in the form below. After you have entered information for a class, click on save, and another row will appear for you to enter information about another class. Continue until you have entered information for all classes that contain eighth-grade students.</p><p>
                    ...
                    Tips: <p>
                        <ul>
                            ...
                            src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/Critical.png' 
                            width="15"></img> at the beginning of a saved class row.</li><li>Use the <i>Print</i> button to print a list of the classes you included for 
                        reference.</li><li>Each class name must be unique. Do not just type in “Grade 8 class” several times. We must be able to differentiate between classes, so please use different class names for each class with at least one 8th-grade student.</li><li>Click on the <i>Finished</i> button when you have entered all eighth-grade math  
                        classes in the form. Then go to the Submit Student List page.</li></ul><p>
                        </p>
                        <div ID="popG8ClassName" class="popbox">
                            ...
                            <b><i>Class Group or Track</i></b> (use Average if none): 
                            ...
                            <tr ID="trG8Header" runat="server" 
                                ...
                                <td align="center">
                                    ...
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Mathematics Class Name</b> <br />(each class name must be unique)</font> </td><td align="center">
                                    <a class="popper" data-popbox="popG8ClassGroup" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a></font>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Class Group or Track (use Average if none)</b></font> </td><td align="center" style="width:15%">
                                    <a class="popper" data-popbox="popG8NumStu" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Number of 8th-grade students in this mathematics class<br />(most classes have less than 30 students)</b> </font></td><td align="center">
                                    <a class="popper" data-popbox="popG8ClassExclusion" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<font size="2"><b>Class<br />Exclusion<br />Status (If applicable)</b></font> </td><td align="center">
                                    <a class="popper" data-popbox="popG8NameofMath" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Name of Mathematics Teacher</b></font> </td><td align="center"><a class="popper" data-popbox="popG8NameofMathEmail" href="#">
                                    <img border="0" 
                                        src='<%= Page.ResolveClientUrl("~/")%>common/images/tooltip/info.png' 
                                        width="15"></img></a>&nbsp;<b><font color="white">&#10038;</font></b><font size="2"><b>Email address of Mathematics Teacher</b></font></td></tr><asp:Repeater ID="RepeaterClassList8ReadOnly" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td align="center">
                                            &nbsp;</td><td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="db_NameOfMathematicsTeacherEmailG8" runat="server" MaxLength="60" 
                                                onchange="Edited();" size="35" Text='<%#Container.DataItem("NameOfMathematicsTeacherEmailG8")%>'></asp:TextBox><asp:RegularExpressionValidator ID="regexEmailValidNameOfMathematicsTeacherEmailG8" runat="server" 
                                                         ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
